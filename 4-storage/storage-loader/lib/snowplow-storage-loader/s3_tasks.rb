  ...
  module StorageLoader
    ...
    private
      ...
      def archive_files_of_type(s3, config, file_type)
        ...
        filtered_archive = config[:s3][:buckets][file_type][:archive_filtered]
        unless filtered_path.nil? or filtered_archive.nil?
          filtered_location = Sluice::Storage::S3::Location.new(filtered_path)
          archive_location = Sluice::Storage::S3::Location.new(filtered_archive)
